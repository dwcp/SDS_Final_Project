...
games <- subset(games, select = -c(PriceFinal, SupportEmail, SupportURL))
```
...
games.pca <- prcomp(games_model[,c(1:56)], center = TRUE, scale. = TRUE)
summary(games.pca)
games_model
games.pca$rotation
...
#Attempt using non-factor stuff
